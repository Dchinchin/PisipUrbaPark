...
namespace UrbaPark.Aplicacion.ServicioImpl
{
    public class BitacoraServicioImpl : IBitacoraServicio
    {
        ...
        {
            bitacoraRepositorio = new BitacoraRepositorioImpl(pisip_UrbanParkContext);
        }
        ...
        public Task<List<Bitacora>> ListarBitacoraActivo()
        {
            return bitacoraRepositorio.ListarBitacoraActivo();
        }
    }
}
